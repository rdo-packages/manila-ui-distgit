...
%{?dlrn: %global tarsources manila-ui}
%{!?dlrn: %global tarsources manila_ui}
...
%config(noreplace) %attr(0640, root, apache) %{_sysconfdir}/openstack-dashboard/default_policies/manila.yaml
%config(noreplace) %attr(0640, root, apache) %{_sysconfdir}/openstack-dashboard/manila_policy.yaml
...
%changelog
# REMOVEME: error caused by commit https://opendev.org/openstack/manila-ui/commit/863eb24326cf048b0bac394a0b4e771f1ea6e6a6
